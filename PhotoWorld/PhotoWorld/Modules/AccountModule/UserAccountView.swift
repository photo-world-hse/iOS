...
//            Picker("Favorite Color", selection: $profileInfoViewSelection, content: {
//                            Text("Фотографии").foregroundColor(ColorConstants.WhiteA700).tag(0)
//                            Text("Информация").foregroundColor(ColorConstants.WhiteA700).tag(1)
//                            Text("Отзывы").foregroundColor(ColorConstants.WhiteA700).tag(2)
//                        })
