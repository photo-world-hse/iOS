...
class Themes {
    ...
    static let messageTheme = SBUChannelTheme(navigationBarTintColor: secondMain, navigationBarShadowColor: secondMain, leftBarButtonTintColor: white, rightBarButtonTintColor: white, backgroundColor: main)
