...
struct PhotosessionView<model: PhotosessionViewModelIO>: View {
    ...
    func formatTime() -> String {
        let startDate = Date(timeIntervalSince1970: viewModel.photosession.start_date_and_time)
        let endDate = Date(timeIntervalSince1970: viewModel.photosession.end_date_and_time)
    ...
    var body: some View {
                    ...
                    Group {
                        ...
                        VStack {
                            ForEach(viewModel.filterParticipants(index: participantTypeIndex)) { el in
                                ParticipantCellView(participant: el)
        ...
        .onAppear(perform: {viewModel.refreshView()} )
    }
}
