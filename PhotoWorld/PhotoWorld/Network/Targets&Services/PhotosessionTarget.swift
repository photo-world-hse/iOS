...
enum PhotosessionTarget: TargetType {
    ...
    case inviteParticipant(participant: ParticipantShortInfo, photosessionID: String, token: String)
    ...
    var path: String {
        ...
        case .acceptInvite(let photosesionId, let profileType, _):
            return "/\(photosesionId)participants/accept/\(profileType.networkTitle)"
    ...
    var task: Task {
        ...
        case .inviteParticipant(let participant, _, _):
